...
const search = async () => {
 const baseSearchUrl = import.meta.env.VITE_APP_URL + "/api/search";
 ...
 <div>
  ...
  <div class="results-section mt-3">
   ...
   <div v-if="!state.isLoading">
    <p>
     Showing {{ firstResultOfPage }} to {{ lastResultOfPage }} of
     {{ state.total_results }} entries with {{ state.frozen_variant }}% variance
    </p>
